...
const (
	...
	defaultSessionDir = ".etch/sessions"
	...
	// commandConfig inspects project-local etch configuration.
	...
	// etchUserAgent identifies this CLI on provider HTTP requests.
	etchUserAgent = "etch"
)
...
// printTopLevelHelp writes the command overview for the etch binary.
func printTopLevelHelp(stdout io.Writer) {
	fmt.Fprintln(stdout, "etch is a minimal Go coding-agent.")
	fmt.Fprintln(stdout)
	fmt.Fprintln(stdout, "Usage:")
	fmt.Fprintln(stdout, `  etch -p "prompt" [flags]`)
	fmt.Fprintln(stdout, "  etch chat [flags]")
	fmt.Fprintln(stdout, "  etch resume [flags] <session-id-prefix>")
	fmt.Fprintln(stdout, "  etch auth <login|status|logout> [flags]")
	fmt.Fprintln(stdout, "  etch config <check|show|schema> [flags]")
	fmt.Fprintln(stdout, "  etch tool <name> [flags] [args]")
	fmt.Fprintln(stdout, "  etch sessions [flags]")
	fmt.Fprintln(stdout, "  etch show [flags] <session-id-prefix>")
	fmt.Fprintln(stdout, "  etch compact --session <id> [flags]")
	fmt.Fprintln(stdout, "  etch help [command]")
	fmt.Fprintln(stdout)
	...
	fmt.Fprintln(stdout)
	fmt.Fprintln(
		stdout, "Use \"etch help <command>\" for command flags.",
	)
}
...
func printConfigHelp(stdout io.Writer) {
	fmt.Fprintln(stdout, "Usage:")
	fmt.Fprintln(stdout, "  etch config check")
	fmt.Fprintln(stdout, "  etch config show [--effective]")
	fmt.Fprintln(stdout, "  etch config schema")
	fmt.Fprintln(stdout)
	fmt.Fprintln(stdout, "Use \"etch help config show\" for show flags.")
}

// printAuthHelp writes a compact auth command overview.
func printAuthHelp(stdout io.Writer) {
	fmt.Fprintln(stdout, "Usage:")
	fmt.Fprintln(stdout, "  etch auth login [flags]")
	fmt.Fprintln(stdout, "  etch auth status [flags]")
	fmt.Fprintln(stdout, "  etch auth logout [flags]")
	fmt.Fprintln(stdout)
	fmt.Fprintln(stdout, "Use \"etch help auth login\" for auth flags.")
}
...
func printToolHelp(stdout io.Writer) {
	...
	fmt.Fprintln(stdout)
	fmt.Fprintln(stdout, "Use \"etch help tool <name>\" for tool flags.")
}
